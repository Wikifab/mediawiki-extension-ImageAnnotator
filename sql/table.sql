...
CREATE INDEX /*i*/annotatedimages_page_id_hash ON /*_*/annotatedimages (ai_page_id, ai_hash);
CREATE INDEX /*i*/annotatedimages_filename_hash ON /*_*/annotatedimages (ai_filename, ai_hash);
